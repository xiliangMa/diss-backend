...
func init() {
	...
	beego.GlobalControllerRouter["github.com/xiliangMa/diss-backend/controllers/system/system:RespCenterController"] = append(beego.GlobalControllerRouter["github.com/xiliangMa/diss-backend/controllers/system/system:RespCenterController"],
		beego.ControllerComments{
			Method:           "GetRespCenterList",
			Router:           `/respcenter`,
			AllowHTTPMethods: []string{"post"},
			MethodParams:     param.Make(),
			Filters:          nil,
	...
	beego.GlobalControllerRouter["github.com/xiliangMa/diss-backend/controllers/system/system:RespCenterController"] = append(beego.GlobalControllerRouter["github.com/xiliangMa/diss-backend/controllers/system/system:RespCenterController"],
		beego.ControllerComments{
			Method:           "GetRespCenter",
			Router:           `/respcenter/:id`,
			AllowHTTPMethods: []string{"post"},
			MethodParams:     param.Make(),
			Filters:          nil,
			Params:           nil})
	...
	beego.GlobalControllerRouter["github.com/xiliangMa/diss-backend/controllers/system/system:RespCenterController"] = append(beego.GlobalControllerRouter["github.com/xiliangMa/diss-backend/controllers/system/system:RespCenterController"],
		beego.ControllerComments{
			Method:           "ContainerOperation",
			Router:           `/respcenter/operation`,
			AllowHTTPMethods: []string{"post"},
			MethodParams:     param.Make(),
			Filters:          nil,
			Params:           nil})
	...
	beego.GlobalControllerRouter["github.com/xiliangMa/diss-backend/controllers/system/system:SystemController"] = append(beego.GlobalControllerRouter["github.com/xiliangMa/diss-backend/controllers/system/system:SystemController"],
		beego.ControllerComments{
			Method:           "AddWarningWhiteList",
			Router:           `/system/warnwhitelist`,
			AllowHTTPMethods: []string{"post"},
			MethodParams:     param.Make(),
			Filters:          nil,
			Params:           nil})
	...
	beego.GlobalControllerRouter["github.com/xiliangMa/diss-backend/controllers/system/system:SystemController"] = append(beego.GlobalControllerRouter["github.com/xiliangMa/diss-backend/controllers/system/system:SystemController"],
		beego.ControllerComments{
			Method:           "UpdateWarningWhiteList",
			Router:           `/system/warnwhitelist/:id`,
			AllowHTTPMethods: []string{"put"},
			MethodParams:     param.Make(),
			Filters:          nil,
			Params:           nil})
