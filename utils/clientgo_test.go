...
func Test_CreateK8sClient(t *testing.T) {
	clientgo = CreateK8sClient(kubeconfig, path, configName); if clientgo.err == nil {
...
func Test_GetNodes(t *testing.T) {
	if clientgo.err == nil {
		nodes, err := clientgo.GetNodes(); if err == nil {
...
func Test_GetPodsByNameSpace(t *testing.T) {
	if clientgo.err == nil {
		pods, err := clientgo.GetPodsByNameSpace(namespaces); if err == nil {
